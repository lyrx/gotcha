...
trait IpfsTrait{
  ...
  def bufferToIpfs(buffer: nodeLib.Buffer)(implicit ctx: ExecutionContext): Future[Option[String]]
  ...
  def saveStringToIpfs(s: String)(implicit ctx: ExecutionContext): FOption[String] =
    saveBufferToIpfs(
